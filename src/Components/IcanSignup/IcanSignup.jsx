    ...
    <div className='container'>
      <form className='header' onSubmit={handleSignup}>
        ...
        <div className='inputs'>
          ...
          <div className='input'>
            <input type="phone_number" placeholder='Phone Number' value={phonenumber} onChange={(e) => setPhoneNumber(e.target.value)} />
          </div>
          <select name="country" class="form-control" id="country" value={country} onChange={(e) => setCountry(e.target.value)}>
          ...
          <div className='input' value={dateofbirth} onChange={(e) => setDateofBirth(e.target.value)}>
            <input type="date" placeholder='Day of Birth' onfocus="(this.type='date')" id='date' />
          </div>
        </div>
        ...
        <div className='text2'>Guests can view HealthCare app, and read news.</div>
        <div>
          <h2>Haven't got an account?</h2>
        </div>
        <div className='int2'>
